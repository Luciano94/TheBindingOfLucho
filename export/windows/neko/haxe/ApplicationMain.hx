...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Amaka", "TheBindingOfLucho", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "TheBindingOfLucho";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "TheBindingOfLucho", null, { width: 640, height: 480 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "17",
			company: "Amaka",
			file: "TheBindingOfLucho",
			fps: 60,
			name: "TheBindingOfLucho",
